...
SELECT TENCONGTY,NGAYBATDAU FROM CONGTY CT
...
SELECT CG.MaChuyenGia,HOTEN,COUNT(MADUAN) AS SLDA FROM ChuyenGia CG
...
SELECT DISTINCT DA.MADUAN FROM DUAN DA
...
SELECT CT.MACONGTY, TENCONGTY,COUNT(MADUAN) AS SLDA FROM CONGTY CT
JOIN DuAn DA ON DA.MaCongTy=CT.MaCongTy
...
SELECT DISTINCT CG1.MACHUYENGIA, CG2.MACHUYENGIA, CG1.MADUAN FROM ChuyenGia_DuAn CG1
